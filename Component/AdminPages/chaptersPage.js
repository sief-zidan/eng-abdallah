...
export default class chaptersPage extends React.Component {
  ...
  deleteChapter(chapter_id, index) {
    let dataToSend = {
      chapter_id,
    };
    console.log(dataToSend);
    Axios.post(basic.url + 'delete_chapters.php', dataToSend).then((res) => {
      if (res.status == 200) {
  ...
  addChapter() {
    ...
    console.log(dataToSend);
    Axios.post(basic.url + 'challenge/add_chapter.php', dataToSend)
      .then((res) => {
        if (res.status == 200) {
          console.log(res.data);
  ...
  getChapters() {
    ...
    Axios.post(basic.url + 'select_chapterts.php', dataToSend)
      .then((res) => {
        if (res.status == 200) {
