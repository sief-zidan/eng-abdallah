...
export default class ChainVideosList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      My_videos_array: [],
      ...
      chain_id: this.props.navigation.getParam('chain_id'),
    };
  }
  ...
  async addVideo() {
    ...
    if (error == 0) {
      ...
      axios
        .post(basic.url + 'admin/upload_video_data.php', dataToSend)
        .then((res) => {
  ...
  async editVideo() {
    ...
    if (error == 0) {
      ...
      axios
        .post(basic.url + 'admin/edit_video_data.php', dataToSend)
        .then((res) => {
          if (res.status == 200) {
            if (res.data == 'success') {
              ToastAndroid.showWithGravityAndOffset(
      ...
      [
        {
          ...
          onPress: async () => {
            ...
            axios
              .post(basic.url + 'admin/delete_video.php', dataToSend)
              .then((res) => {
                console.log(res.data);
                if (res.data == 'success') {
  ...
  async update_show_video(video_index) {
    ...
    axios
      .post(basic.url + `admin/update_show_video.php`, data_to_send)
      .then((res) => {
        if (res.status == 200) {
          if (res.data == 'success') {
