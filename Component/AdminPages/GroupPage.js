...
export default class GroupPage extends Component {
  ...
  _deleteGroup(item) {
    ...
    axios
      .post(
        basic.url + `admin/delete_collection.php`,
  ...
  Update_Name_Of_Group() {
    ...
    this.setState({disabled: true});
    axios
      .post(basic.url + `admin/update_collection.php`, data_to_send)
      .then((res) => {
        this.setState({disabled: false});
        // alert(res.data)
        if (res.data != 'error') {
  ...
  add_Group() {
    ...
    if (col_name == '') {
      ...
      axios
        .post(basic.url + `admin/insert_collection.php`, data_to_send)
        .then((res) => {
          this.setState({disabled: false});
