  ...
  allert(index, name, id) {
    Alert.alert(
      ...
      [
        ...
        {
          text: "اعادة", onPress: () => this.Re_Start_Exam(index, id)
        }
      ],
      { cancelable: false }
    );
  ...
  render() {
    return (
      <Container
        ...
        <View style={{ justifyContent: "center", alignContent: "center", marginTop: 7 }}>
