...
export default class AddEditQuestion extends Component {
  ...
  edit_question() {
    ...
    if (obj.question_text.trim() == '') {
      ...
      //   question_image: this.state.change_photo == false ? null : '1',
      //   question_answers: answers,
      //   question_valid_answer: obj.question_valid_answer,
      //   question_exam_quiz_id: this.state.exam_id,
      // };

      // console.log(JSON.stringify(objaa));
      // console.log(basic.url + `admin/edit_ques.php`);
